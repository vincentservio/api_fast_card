...
class DecksControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create deck" do
    assert_difference('Deck.count') do
      post decks_url, params: { deck: { card_id: @deck.card_id, category: @deck.category } }, as: :json
    end
  ...
  test "should update deck" do
    patch deck_url(@deck), params: { deck: { card_id: @deck.card_id, category: @deck.category } }, as: :json
    assert_response 200
  end
